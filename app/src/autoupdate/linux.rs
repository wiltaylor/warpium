        ...
        fn render(&self, app: &warpui::AppContext) -> Box<dyn warpui::Element> {
            ...
            let mut lines = vec![
                ...
                FormattedTextLine::Line(vec![
                    FormattedTextFragment::plain_text("If you installed Warpium using "),
                    FormattedTextFragment::bold(package_manager_name),
                    FormattedTextFragment::plain_text(
                        " or a compatible tool, the pre-filled command will update Warpium for you.",
                    ),
                ]),
            ];
            ...
            if self.package_manager.needs_repository_configuration() {
                lines.push(FormattedTextLine::Line(vec![
                    FormattedTextFragment::plain_text(
                        "\nThe command below includes a one-time configuration of the Warpium package repository and PGP signing key.",
                    ),
                ]));
            }
            ...
            lines.push(FormattedTextLine::Line(vec![
                ...
                FormattedTextFragment::plain_text(" to install the update and re-launch Warpium.  "),
