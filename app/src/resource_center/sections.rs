    ...
    let get_started = FeatureSectionData {
        ...
        items: vec![
            ...
            FeatureItem::new(
                ...
                "Access all of Warpium via the keyboard.",
                Tip::Action(TipAction::CommandPalette),
                ctx,
            ),
            FeatureItem::new(
                "Set your theme",
                "Make Warpium your own by choosing a theme.",
    ...
    let advanced_setup = ContentSectionData {
        ...
        items: vec![
            ContentItem {
                ...
                description: "Set up Warpium to honor your PS1 setting",
                url: "https://docs.warp.dev/terminal/appearance/prompt",
                button_label: "View documentation",
            },
            ContentItem {
                title: "Integrate Warpium with your IDE",
                description: "Configure Warpium to launch from your most used development tools",
                url: "https://docs.warp.dev/terminal/integrations-and-plugins",
                button_label: "View documentation",
            },
            ContentItem {
                title: "How Warpium uses Warpium",
                description: "Learn how Warpium's engineering team uses their favorite features",
